...
appointmentRouter.delete("/:id",(req, res, next)=> appointmentController.cancelAppointment(req, res));
...
appointmentRouter.get("userId/:doctorId",(req, res, next)=> appointmentController.getAppointmentsByDoctor(req, res, next));//doctor fetching his future appointments
