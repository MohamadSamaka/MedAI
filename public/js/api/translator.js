...
function observeTopbar() {
  ...
  console.log("inside translatorrrrrrrrrr", topbar);
  if (!topbar) {
    console.error("No element with id 'topbar' found. in tra");
    return;
  } else {
    console.log("element  id 'topbar' found in translatorrrr.");
  }

  console.log("======>>", topbar.querySelector(".topbar-left"));
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  setTimeout(function () {
    console.log("translator runss nowww @@@@@@@@@@");
    observeTopbar();
  }, 7000);
});
